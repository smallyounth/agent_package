...
| 题目要求 | 本包对应文件 |
|---|---|
| GitHub/Gitee/代码包或核心目录截图 | `README.md`、`screenshots_and_recording/01-core-directory.svg` |
| README 和启动方式 | `README.md`、`RUNBOOK_10MIN.md` |
| 面试官快速测试路径和命令 | `INTERVIEWER_QUICK_START.md` |
| 3-5 分钟录屏或关键运行截图 | `RECORDING_OR_SCREENSHOTS.md`、`screenshots_and_recording/*` |
...
| Agent 状态流/工具调用边界 | `ARCHITECTURE.md`、`screenshots_and_recording/04-agent-state-flow.svg` |
